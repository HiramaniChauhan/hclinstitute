...
export const TestInterface = ({ test, onComplete, onCancel, reviewMode = false, answers, allAttempts = [], initialAttemptIdx }: TestInterfaceProps) => {
    ...
    return createPortal(
        <div className="fixed inset-0 bg-slate-50 lg:bg-white z-[10000] overflow-hidden flex flex-col p-1 sm:p-2 md:p-3 lg:p-4 animate-in fade-in duration-500">
            ...
            <div className="max-w-7xl w-full mx-auto h-full flex flex-col space-y-1 md:space-y-2">
                <div className={`flex-shrink-0 flex ${reviewMode ? 'flex-col sm:flex-row items-start sm:items-center flex-wrap gap-y-2' : 'items-center'} justify-between bg-white/90 backdrop-blur-md z-10 p-2 md:p-2.5 border-b rounded-lg shadow-sm mb-1 lg:mb-2`}>
